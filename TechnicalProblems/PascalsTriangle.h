...
/**
 * Problem: Given a non-negative integer numRows, generate the first numRows of
 * Pascal's triangle. For example, if the number of rows given is 5, then generate
 * the first 5 rows of Pascal's Triangle, which is represented as an array of int
 * arrays.
 *
 * Questions:

...
public:
	 ...
	 * subarray. 
	 *
	 * If the sum of the previous subarray and the current number is greater 
	 * than the current number, then we will extend the subarray to include this
	 * number. Otherwise, we will just have the current number as the only 
